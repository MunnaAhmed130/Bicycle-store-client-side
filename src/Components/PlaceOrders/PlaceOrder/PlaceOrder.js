...
const PlaceOrder = () => {
    ...
    useEffect(() => {
        fetch(`https://bicycle-store-server-side.vercel.app/products/${id}`)
            .then((res) => res.json())
    ...
    const { userName, email, productName, url, price, description } =
        initialInfo;
    ...
    const onSubmit = (e) => {
        ...
        axios
            .post(
                "https://bicycle-store-server-side.vercel.app/purchase",
                purchaseInfo
            )
            .then((res) => {
                console.log(res);
            ...
            <Container>
                <Row>
                    <Col
                        ...
                        sm={12}
                        lg={6}
                        className="purchase-img-container p-0"
                    >
